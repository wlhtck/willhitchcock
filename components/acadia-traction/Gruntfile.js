...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        uglify: {
            dist: {
                src: ['<%= pkg.directory_source %>/js/acadia-traction.js'],
                dest: '<%= pkg.directory_source %>/js/acadia-traction.min.js'
            }
        },
        concat: {
            dist: {
                src:'<%= pkg.directory_source %>/js/acadia-traction.min.js',
                dest: '<%= pkg.directory_build %>/js/acadia-traction.min.js'
            }
        },
        ...
        sass: {
          dist: {
            ...
            files: {
              '<%= pkg.directory_source %>/css/acadia-traction.css': '<%= pkg.directory_source %>/sass/main.scss'
            }
          }
        },
        cssmin: {
